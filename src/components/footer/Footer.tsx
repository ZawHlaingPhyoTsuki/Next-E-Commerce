      ...
      <div className="flex flex-col sm:grid sm:grid-cols-2 lg:grid lg:grid-cols-5 gap-[80px] mb-8">
        ...
        <div className=" col-span-1">
          ...
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-3 justify-between mt-4 text-xl">
            <Link href={"https://www.facebook.com/ZawHlaingPhyo.23"}>
              <FaFacebookF className="hover:text-[#d2d2d2] text-white" />
            </Link>
            <Link href={"https://x.com/ZawHlaingPhyo"}>
              <FaTwitter className="hover:text-[#d2d2d2] text-white" />
            </Link>
            <Link href={"https://www.instagram.com/tsukuyomi1123/"}>
              <FaInstagram className="hover:text-[#d2d2d2] text-white" />
            </Link>
            <Link href={"https://github.com/ZawHlaingPhyoTsuki"}>
